...
public class BlockInit {
    ...
    public static final RegistryObject<Block> JELLO_CRYSTAL_BLOCK = register("jello_crystal_block", () -> new GlassBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_RED).strength(1.0f).sound(SoundType.METAL)), object -> () -> new BlockItem(object.get(), new Item.Properties().tab(MINEBOUND_TAB)));
