...
public class MagicConfigRegistry extends ServerConfigRegistry implements IConfig {
    ...
    public static final FireUtilitySpell.FireUtilitySpellConfig FIRE_UTILITY_2 = new FireUtilitySpell.FireUtilitySpellConfig(5, 10, 0.5, 40, ArmorTier.SUIT);
    public static final FireUtilitySpell.FireUtilitySpellConfig FIRE_UTILITY_3 = new FireUtilitySpell.FireUtilitySpellConfig(7, 15, 1.0, 20, ArmorTier.SYNERGY);
    public static final FireUtilitySpell.FireUtilitySpellConfig FIRE_UTILITY_4 = new FireUtilitySpell.FireUtilitySpellConfig(10, 20, 1.5, 20, ArmorTier.SINGULARITY);
