...
public class MagicConfigRegistry extends ServerConfigRegistry implements IConfig {
    ...
    /* Electric */
    public static final ElectricDefensiveSpell.ElectricDefensiveConfig ELECTRIC_DEFENSIVE_1 = new ElectricDefensiveSpell.ElectricDefensiveConfig(20, 5, 100, ArmorTier.EFFIGY);
    public static final ElectricDefensiveSpell.ElectricDefensiveConfig ELECTRIC_DEFENSIVE_2 = new ElectricDefensiveSpell.ElectricDefensiveConfig(20, 10, 200, ArmorTier.SUIT);
    public static final ElectricDefensiveSpell.ElectricDefensiveConfig ELECTRIC_DEFENSIVE_3 = new ElectricDefensiveSpell.ElectricDefensiveConfig(20, 10, 300, ArmorTier.SYNERGY);
