...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> MYRIAL_GLASS_BLOCK = BLOCKS.register("myrial_glass_block", () -> new Block(Properties.copy(Blocks.GLASS).noOcclusion().requiresCorrectToolForDrops().strength(30f, 500f)));
