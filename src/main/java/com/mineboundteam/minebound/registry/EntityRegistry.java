...
import com.mineboundteam.minebound.entity.MyrialSword;
...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<MyrialSword>> MYRIAL_SWORD = ENTITIES.register("myrial_sword", () -> EntityType.Builder.of(MyrialSword::new, MobCategory.MISC).build("myrial_sword"));
