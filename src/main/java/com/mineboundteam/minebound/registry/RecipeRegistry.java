...
public class RecipeRegistry {
    ...
    public static final RegistryObject<RecipeType<ArmorForgeRecipe>> ARMOR_FORGE_RECIPE =  RECIPE_TYPE.<RecipeType<ArmorForgeRecipe>>register("armor_forge", () -> new RecipeType<ArmorForgeRecipe>() {
