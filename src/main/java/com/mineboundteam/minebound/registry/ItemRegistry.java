...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> TEST_SPELL = ITEMS.register("test_spell", ()-> new TestSpell(new Item.Properties().tab(MineBound.MINEBOUND_TAB).stacksTo(1), SpellLevel.Level1, MagicConfigRegistry.TEST_SPELL));
}
