...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> MYRIAL_DIAMOND_AXE = ITEMS.register("myrial_diamond_axe", () -> new AxeItem(ToolTier.MYRIAL_DIAMOND, 4, -2, new Item.Properties().tab(MineBound.MINEBOUND_TAB)));
