...
/**
 * Adapted from {@link mezz.jei.common.plugins.vanilla.cooking.AbstractCookingCategory}
 */
public class AlloyFurnaceRecipeCategory implements IRecipeCategory<AlloyFurnaceRecipe> {
    ...
    public AlloyFurnaceRecipeCategory(IGuiHelper guiHelper){
		...
		icon = guiHelper.createDrawableItemStack(new ItemStack(BlockRegistry.ALLOY_FURNACE.get())); 
