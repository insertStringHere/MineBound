...
public class ToolTier {
    ...
    public static final ForgeTier GILDED_DIAMOND = new ForgeTier(3, 1561, 8, 3, 8, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemRegistry.GILDED_DIAMOND_INGOT.get()));
}
