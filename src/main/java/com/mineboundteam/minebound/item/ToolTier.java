...
public class ToolTier {
    ...
    public static final ForgeTier ILLUMINANT_STEEL = new ForgeTier(3, 1561, 7, 3, 10, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemRegistry.ILLUMINANT_STEEL_INGOT.get()));
}
