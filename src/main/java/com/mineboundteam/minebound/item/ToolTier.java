...
public class ToolTier {
    ...
    public static ForgeTier MYRIAL_DIAMOND = new ForgeTier(5, 2750, 10F, 3, 11, Tags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemRegistry.MYRIAL_DIAMOND_INGOT.get()));
}
